        ...
        b2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
              /*  if(TextUtils.isEmpty(email)){
                ...
                Task<AuthResult> result = firebaseAuth.signInWithEmailAndPassword(ed.getText().toString(), ed1.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
                        ...
                        if (task.isSuccessful())
                        {
                           // if(progress!=null){
                             //   progress.hide();
                               // progress=null;
                            //}
                            if (ed.getText().toString().equals("chinmay.mahajan97@gmail.com"))
                            {
